...
- BugFix: Updated the `form-data` dependency for technical currency. []()

## `6.1.14`

- BugFix: Updated the `axios` dependency for technical currency. [#203](https://github.com/zowe/zowe-cli-db2-plugin/pull/203)
...
- BugFix: Updated the `axios` and `lodash` dependencies for technical currency. [#196](https://github.com/zowe/zowe-cli-db2-plugin/pull/196)
...
- BugFix: Updated the `tar-fs` dependency for technical currency. [#191](https://github.com/zowe/zowe-cli-db2-plugin/pull/191)

## `6.1.7`

- BugFix: Updated the `axios` dependency for technical currency. [#187](https://github.com/zowe/zowe-cli-db2-plugin/pull/187)

## `6.1.6`

- BugFix: Updated the `form-data` dependency for technical currency. [#185](https://github.com/zowe/zowe-cli-db2-plugin/pull/185)
...
- BugFix: Updated tar-fs transitive dependency to resolve technical debt. [#176](https://github.com/zowe/zowe-cli-db2-plugin/pull/176)

## `6.1.2`

- BugFix: Updated axios transitive dependency to resolve technical debt. [#174](https://github.com/zowe/zowe-cli-db2-plugin/pull/174)
