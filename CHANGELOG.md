...
- BugFix: Added a post-install check that fails the plug-in installation with instructions for completing the installation of the bundled `ibm_db` package when npm does not run its install script. [#246](https://github.com/zowe/zowe-cli-db2-plugin/pull/246)
- BugFix: Updated and bundled the `ibm_db` package for technical currency. [#246](https://github.com/zowe/zowe-cli-db2-plugin/pull/246)

## `5.0.24`

- BugFix: Updated the `axios` dependency for technical currency. [#245](https://github.com/zowe/zowe-cli-db2-plugin/pull/245)
...
- BugFix: Updated the `tar-fs` dependency for technical currency. [#192](https://github.com/zowe/zowe-cli-db2-plugin/pull/192)
